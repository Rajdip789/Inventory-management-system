...

			{
				...
				<div className="card">
					<div className="container" style={{display:"flex",flexDirection:"column"}}>
						<h3 style={{ marginLeft: "10px", marginTop: "5px", color: "darkseagreen" }}>Basic Expense details</h3>
						...
						<h3 style={{ marginLeft: "10px", marginTop: "5px", color: "darkseagreen" }}>Expense items List</h3>
						...
						{ 
							permission.create && 
							<button className='btn success' style={{alignSelf:"center"}} disabled={submitButtonState} onClick={() => {insertExpense()}} >
